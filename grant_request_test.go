...
func TestNewGrantObjectsPremsBuilder(t *testing.T) {
	...
	h.AssertPathsEqual(t,
		fmt.Sprintf("/v2/auth/grant/sub-key/%s", o.opts.webpubsub.Config.SubscribeKey),
		u.EscapedPath(), []int{})
...
func TestGrantRequestBasic(t *testing.T) {
	...
	h.AssertPathsEqual(t,
		fmt.Sprintf("/v2/auth/grant/sub-key/%s", opts.webpubsub.Config.SubscribeKey),
		u.EscapedPath(), []int{})
...
func TestNewGrantBuilderContext(t *testing.T) {
	assert := assert.New(t)
	o := newGrantBuilderWithContext(webpubsub, backgroundContext)
	o.AuthKeys([]string{"my-auth-key"})
	o.Channels([]string{"ch"})
	o.ChannelGroups([]string{"cg"})
	o.Read(true)
...
func TestGrantTokenOptsValidateSub(t *testing.T) {
	...
	assert.Equal("webpubsub/validation: webpubsub: Grant: Missing Subscribe Key", opts.validate().Error())
}
...
func TestGrantTokenOptsValidateSec(t *testing.T) {
	...
	assert.Equal("webpubsub/validation: webpubsub: Grant: Missing Secret Key", opts.validate().Error())
}
...
func TestGrantTokenOptsValidatePub(t *testing.T) {
	...
	assert.Equal("webpubsub/validation: webpubsub: Grant: Missing Publish Key", opts.validate().Error())
}
