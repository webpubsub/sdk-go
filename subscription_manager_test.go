...
func TestParseCipherInterfacePlainWithCipherMapWPSOther(t *testing.T) {
	assert := assert.New(t)
...
func TestParseCipherInterfacePlainWithoutCipherMapWPSOther(t *testing.T) {
	assert := assert.New(t)
	s1 := map[string]interface{}{
		"id":        1,
		"not_other": "1234567",
...
func TestParseCipherInterfaceCipherWithoutCipherStringWPSOther(t *testing.T) {
	assert := assert.New(t)
	s := map[string]interface{}{
		"id":        1,
		"not_other": "1234",
...
func TestParseCipherInterfaceCipherWithCipherStringWPSOther(t *testing.T) {
	assert := assert.New(t)
	s := map[string]interface{}{
		"id":        1,
		"not_other": "1234",
...
func TestParseCipherInterfaceCipherWithCipherStructWPSOther(t *testing.T) {
	assert := assert.New(t)
	s := map[string]interface{}{
		"id":        1,
		"not_other": "1234",
...
func TestParseCipherInterfaceCipherWithOtherCipherStructWPSOther(t *testing.T) {
	assert := assert.New(t)
	s := map[string]interface{}{
		"id":        1,
		"not_other": "1234",
...
func TestParseCipherInterfaceCipherWithCipherStructWPSOtherDisable(t *testing.T) {
	assert := assert.New(t)
	s := map[string]interface{}{
		"id":        1,
		"not_other": "1234",
