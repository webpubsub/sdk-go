...
func newDeleteFileBuilder(webpubsub *WebPubSub) *deleteFileBuilder {
...
func newDeleteFileBuilderWithContext(webpubsub *WebPubSub,
...
func (b *deleteFileBuilder) Execute() (*WPSDeleteFileResponse, StatusResponse, error) {
	rawJSON, status, err := executeRequest(b.opts)
	if err != nil {
		return emptyDeleteFileResponse, status, err
	}

	return newWPSDeleteFileResponse(rawJSON, b.opts, status)
}
...
func newWPSDeleteFileResponse(jsonBytes []byte, o *deleteFileOpts,
	status StatusResponse) (*WPSDeleteFileResponse, StatusResponse, error) {

	resp := &WPSDeleteFileResponse{}
