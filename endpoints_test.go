...
func TestSignatureV2_1(t *testing.T) {
	...
	query := "l_obj=0.4545555556&l_pam=1.145&pnsdk=WebPubSubCSharp4.0.34.0&requestid=19e1dee9-2f87-45d6-97e5-3f4d3f9779a2&timestamp=1568724043&uuid=mytestuuid"
...
func TestSignatureV2_granttoken(t *testing.T) {
	...
	query := "pnsdk=WebPubSub-Go%2F4.6.5&timestamp=1583755527&uuid=pn-f1df31f1-6ba9-49e1-ae72-084c15404302"
...
func TestSignatureV2_6(t *testing.T) {
	...
	query := "include=custom&pnsdk=WebPubSub-Go/4.6.5&timestamp=1583493622&uuid=pn-01fb5308-f0ce-480b-b051-6ff98ba22467"
