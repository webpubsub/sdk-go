...
func TestNewGetStateBuilder(t *testing.T) {
	...
	o := newGetStateBuilder(webpubsub)
...
func TestNewGetStateBuilderContext(t *testing.T) {
	...
	o := newGetStateBuilderWithContext(webpubsub, backgroundContext)
	o.Channels([]string{"ch"})
	o.ChannelGroups([]string{"cg"})
...
func TestGetStateValidateChannel(t *testing.T) {
	...
	assert.Equal("webpubsub/validation: webpubsub: Get State: Missing Channel or Channel Group", opts.validate().Error())
}
...
func TestGetStateValidateSubscribeKey(t *testing.T) {
	...
	assert.Equal("webpubsub/validation: webpubsub: Get State: Missing Subscribe Key", opts.validate().Error())
}
