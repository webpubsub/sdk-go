...
func (e ValidationError) Error() string {
	return fmt.Sprintf("webpubsub/validation: %s", e.message)
}

func NewValidationError(endpoint, msg string) *ValidationError {
	return &ValidationError{
		message: fmt.Sprintf("webpubsub: %s: %s", endpoint, msg),
	}
}
...
func (e BuildRequestError) Error() string {
	return fmt.Sprintf("webpubsub/build: %s", e.message)
}
...
func (e ServerError) Error() string {
	return fmt.Sprintf(
		"webpubsub/server: Server respond with error code %d: %s", e.StatusCode,
		string(e.Body))
}
...
func (e ConnectionError) Error() string {
	return fmt.Sprintf("webpubsub/connection: %s: %s", e.message,
		e.OrigError.Error())
}
...
func (e ResponseParsingError) Error() string {
	return fmt.Sprintf("webpubsub/parsing: %s: %s", e.message, e.Body)
}
