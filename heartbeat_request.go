...
func newHeartbeatBuilder(webpubsub *WebPubSub) *heartbeatBuilder {
...
func newHeartbeatBuilderWithContext(webpubsub *WebPubSub,
...
func (o *heartbeatOpts) buildQuery() (*url.Values, error) {
	...
	q.Set("heartbeat", strconv.Itoa(o.webpubsub.Config.PresenceTimeout))
