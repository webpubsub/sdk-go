...
func TestNewHistoryBuilderContext(t *testing.T) {
	...
	o := newHistoryBuilderWithContext(webpubsub, backgroundContext)
	o.Channel("ch")
...
func TestHistoryWPSOther(t *testing.T) {
	assert := assert.New(t)
...
func TestHistoryWPSOtherYay(t *testing.T) {
	assert := assert.New(t)
