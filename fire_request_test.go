...
func TestValidatePublishKey(t *testing.T) {
	...
	assert.Equal("webpubsub/validation: webpubsub: Fire: Missing Publish Key", opts.validate().Error())
}
...
func TestValidateSubscribeKey(t *testing.T) {
	...
	assert.Equal("webpubsub/validation: webpubsub: Fire: Missing Subscribe Key", opts.validate().Error())
}
...
func TestValidateChannel(t *testing.T) {
	...
	assert.Equal("webpubsub/validation: webpubsub: Fire: Missing Channel", opts.validate().Error())
}
...
func TestValidateMessage(t *testing.T) {
	...
	assert.Equal("webpubsub/validation: webpubsub: Fire: Missing Message", opts.validate().Error())
}
