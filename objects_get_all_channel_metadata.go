...
var emptyGetAllChannelMetadataResponse *WPSGetAllChannelMetadataResponse
...
func newGetAllChannelMetadataBuilder(webpubsub *WebPubSub) *getAllChannelMetadataBuilder {
	return newGetAllChannelMetadataBuilderWithContext(webpubsub, webpubsub.ctx)
}

func newGetAllChannelMetadataBuilderWithContext(webpubsub *WebPubSub,
...
func (b *getAllChannelMetadataBuilder) Include(include []WPSChannelMetadataInclude) *getAllChannelMetadataBuilder {
...
func (b *getAllChannelMetadataBuilder) Execute() (*WPSGetAllChannelMetadataResponse, StatusResponse, error) {
	rawJSON, status, err := executeRequest(b.opts)
	if err != nil {
		return emptyGetAllChannelMetadataResponse, status, err
	}

	return newWPSGetAllChannelMetadataResponse(rawJSON, b.opts, status)
}
...
func (o *getAllChannelMetadataOpts) operationType() OperationType {
	return WPSGetAllChannelMetadataOperation
}
...
func newWPSGetAllChannelMetadataResponse(jsonBytes []byte, o *getAllChannelMetadataOpts,
	status StatusResponse) (*WPSGetAllChannelMetadataResponse, StatusResponse, error) {

	resp := &WPSGetAllChannelMetadataResponse{}
