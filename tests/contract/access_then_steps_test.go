...
func channelHasPermission(permissions webpubsub.ChannelPermissions, perm string) (bool, error) {
	switch perm {
	case "READ":
...
func channelGroupHasPermission(permissions webpubsub.GroupPermissions, perm string) (bool, error) {
	switch perm {
	case "READ":
		return permissions.Read, nil
	case "MANAGE":
...
func uuidHasPermission(permissions webpubsub.UUIDPermissions, perm string) (bool, error) {
	switch perm {
	case "DELETE":
		return permissions.Delete, nil
	case "UPDATE":
