...
func newSubscribeBuilder(webpubsub *WebPubSub) *subscribeBuilder {
...
func (b *subscribeBuilder) Execute() {
	b.opts.webpubsub.subscriptionManager.adaptSubscribe(b.operation)
}
...
func (o *subscribeOpts) client() *http.Client {
	return o.webpubsub.GetSubscribeClient()
}
...
func (o *subscribeOpts) requestTimeout() int {
	return o.webpubsub.Config.SubscribeRequestTimeout
}
