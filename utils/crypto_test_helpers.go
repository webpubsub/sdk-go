...
// WebpubsubDemoMessage is a struct to test a non-alphanumeric message
type webpubsubDemoMessage struct {
...
type customComplexMessage struct {
	...
	Channels      []string
	DemoMessage   webpubsubDemoMessage `json:",string"`
	SampleXML     string               `json:",string"`
}

// InitComplexMessage initializes a complex structure of the
// type CustomComplexMessage which includes a xml, struct of type WebpubsubDemoMessage,
// strings, float and integer.
func initComplexMessage() customComplexMessage {
	webpubsubDemoMessage := webpubsubDemoMessage{
	...
	customComplexMessage := customComplexMessage{
		...
		DemoMessage:   webpubsubDemoMessage,
