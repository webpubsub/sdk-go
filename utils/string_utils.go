...
import (
	...
	pnerr "github.com/webpubsub/sdk-go/v7/pnerr"
)
...
func CheckUUID(uuid string) {
	if strings.TrimSpace(uuid) == "" {
		panic(pnerr.NewBuildRequestError("uuid: UUID misisng, please set it in the WPSConfig."))
	}
}
